...
class TranslationWaveGesture(Gesture):
    """
    ...
    def __init__(
        ...
        """
        super(TranslationWaveGesture, self).__init__(
    ...
    def apply(self, displacement_data: dict, current_frame: int) -> dict:
        ...
        translation = self._get_arm_rotation_at_frame(current_frame) - self._get_arm_rotation_at_frame(current_frame - 1)
